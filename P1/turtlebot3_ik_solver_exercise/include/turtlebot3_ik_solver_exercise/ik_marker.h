#ifndef TURTLEBOT3_IK_MARKER_H__
#define TURTLEBOT3_IK_MARKER_H__
...
#define INT_MARKER_NAME "gripper"
...
public:
  // typedefs
  typedef boost::shared_ptr<IKMarker> Ptr;
  typedef boost::shared_ptr<const IKMarker> ConstPtr;

  IKMarker(const std::string& topic, const std::string& base_frame = "base_link", double marker_scale = 1.0);
  virtual ~IKMarker();
